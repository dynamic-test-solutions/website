...
if($_GET['a']=='d'){
	if($_GET['i']){
		...
		$db->deleteRow('job_table',$conditons);
		header("location:viewsubmenu.php?Action=Deleted");
	}
}
    ...
    <div id="page-content" class="clearfix">
      ...
      <div class="row-fluid">
        ...
        <div class="alert alert-block alert-success">
         ...
         <?php } ?> 
        <div class="row-fluid" id="job_list"> </div>
...
<script type="text/javascript">
			...
			$(document).ready(function() {
			    ...
			    $("#job_list" ).load( "ajaxjob.php"); //load initial records
			   
			    //executes code below when user click on pagination links
			    $("#job_list").on( "click", ".paginations a", function (e){
			        e.preventDefault();
			      ...
			      //  product_type=product_type?product_type:'';
			        $("#innerpage_list").load("ajaxjob.php",{"page":page}, function(){ //get content from PHP page
