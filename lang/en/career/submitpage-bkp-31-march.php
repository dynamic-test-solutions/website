<?php
	...
	if ($_POST["submit"]) {
		...
		$phone = $_POST['phone'];
		$from = $_POST['fname']; 
		$to = 'dreammakerz.sugumar@gmail.com'; 	   //dreammakerz.sugumar@gmail.com,HR@dynamic-test.com,salesca@dynamic-test.com,petea@dynamic-test.com
      ...
      <div class="span12 left0">
        ...
        <div class="span6">
          <form class="enquiry-form" role="form" method="post" action="submitpage.php" onsubmit="return Validate(this);" enctype="multipart/form-data">
            ...
            <div class="span5">
            <div class="form-group">
              <label for="email" class="col-sm-2 control-label">Position Applied For</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="position" name="position"  disabled value="<?php echo $_SESSION['jobtitle']; ?>">
               </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                ...
                <input type="hidden" name="ctry" value="<?php echo $_REQUEST['c']; ?>" />
                <input type="hidden" name="jobtitle" value="<?php echo $_REQUEST['t']; ?>" />
