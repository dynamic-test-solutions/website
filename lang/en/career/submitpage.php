		...
		if (is_uploaded_file($fileatt)) {
		 ...
		 $message .= "--{$mime_boundary}\n" .
		  ...
		  $message .= "Content-Type: application/octet-stream; name=\"".basename($fileatt)."\"\n" .  
                    "Content-Description: ".basename($fileatt)."\n" . 
...
if (!$errFname && !$errEmail && !$errPhone && !$errempty && !$errsize && !$errJobTitle && !$errCountry)
	
	{
        ...
        // Boundary for the email parts
        $boundary = "boundary";

        // Message part
        $message_check = "This is the email message body.";
        
        $message_check.="Name: ".$fname."\n";
        $message_check.="Mobile: ".$phone."\n";
        $message_check.="Email: ".$email."\n";
        $message_check.="Position Applied For: ".$jobtitle."\n";
        $message_check.="Country Applied For: ".$place."\n";
