<?php
	...
	if ($_POST["submit"]) {
		...
		$phone = $_POST['phone'];
		$from = $_POST['fname']; 
		$to = 'kartik.frendz@gmail.com'; 	
		//$to = 'dreammakerz.sugumar@gmail.com'; 		   			   //dreammakerz.sugumar@gmail.com,salesca@dynamic-test.com,petea@dynamic-test.com
...
//if (!$errFname && !$errEmail && !$errPhone ) {
	...
	if (mail($to, $subject,$message,$headers)) {
		...
		Thank you for applying to the career opportunity at DTS!
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="span12 left0">
        ...
        <br />
        <div class="span6">
          <form class="enquiry-form" role="form" method="post" action="test.php" onsubmit="return Validate(this);" enctype="multipart/form-data">
            ...
            <div class="span5">
            <div class="form-group">
              <label for="email" class="col-sm-2 control-label">Alternate Mobile No</label>
              <div class="col-sm-10">
