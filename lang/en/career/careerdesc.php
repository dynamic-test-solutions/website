...
$getrecord=mysqli_query($db->CON,$query);
  ...
  <div class="container">
    <div class="row">
      ...
      <?php 
	   ...
	   //echo $query;
       $view=mysqli_query($db->CON,$query);	
        ...
        <div class="pad20px_r right0"> <br>
          <div class="drawer">
            ...
            <div class="drawer-item">
             ...
             <a class="btn btn-primary" href="submitpage.php?t=<?php echo $row['job_title']; ?>&c=<?php echo $row['country_list']; ?>"> Apply </a>
			  </div>
