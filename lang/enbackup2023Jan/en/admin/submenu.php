	...
	if($_POST)
	{
		//print_r($_FILES['product_type_image']);exit;
				...
				//print_r($type_arguments);exit;
				 ...
				 header("location:viewsubmenu.php?Action=Added");
  ...
  <div id="sidebar">
    <ul class="nav nav-list">
      ...
      <li><a href="#" class="dropdown-toggle"> <i class="icon-picture"></i> <span>Jobs</span> <b class="arrow icon-angle-down"></b> </a>
        <ul class="submenu">
          <li class="active"><a href="viewsubmenu.php"> <i class="icon-picture"></i> <span>View Jobs</span> <b class="arrow icon-angle-down"></b> </a></li>
  ...
  <div id="main-content" class="clearfix">
    <div id="page-content" class="clearfix">
      ...
      <div class="product_type">
        ...
        <form class="form-horizontal" id="job_form" name="job_form" method="post" action="?act=add" enctype="multipart/form-data">
...
<script type="text/javascript">
			...
			$(function() {
				...
				function myconfirm() {
			   	resut= confirm("Are you sure delete Record !!! ");
				   if(!resut){
					   return false;
				   }
				}
