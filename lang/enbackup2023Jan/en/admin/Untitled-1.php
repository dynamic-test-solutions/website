		...
		//print_r($_FILES['country_flag']);exit;
			 ...
			 if($_POST['user_id']==''){
				...
				// echo "</pre>";
				 ...
				 header("location:settings.php?Action=Added");
			 }else{
			 	 $db=new database;			 
  ...
  <div id="sidebar">
    <ul class="nav nav-list">
      ...
      <li><a href="#" class="dropdown-toggle"> <i class="icon-picture"></i> <span>Setting</span> <b class="arrow icon-angle-down"></b> </a>
        <ul class="submenu">
          <li class="active"><a href="settings.php"> <i class="icon-picture"></i> <span>Add Settings</span> <b class="arrow icon-angle-down"></b> </a></li>
        </ul>
      </li>
    </ul>
    <!--/.nav-list-->
  ...
  <div id="main-content" class="clearfix">
    <div id="page-content" class="clearfix">
      ...
      <div class="product_type">
        ...
        <form class="form-horizontal" id="type_form" name="type_form" method="post" action="" enctype="multipart/form-data">
...
<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				id=id?id:'';
			    $("#type_list" ).load( "ajaxsettings.php",{}); //load initial records
			    ...
			    $("#type_list").on( "click", ".paginations a", function (e){
			        ...
			        $("#type_list").load("ajaxsettings.php",{"page":page}, function(){ //get content from PHP page
