	...
	if($_POST)
	{
		//print_r($_FILES['product_type_image']);exit;
				...
				//print_r($type_arguments);exit;
				 $type_id=$db->insert("job_table",$type_arguments);
				 		 	
				 header("location:submenu.php?Action=Added");
...
if($_GET['a']=='d'){
	if($_GET['i']){
		...
		header("location:viewplace.php?Action=Deleted");
	}
}
    ...
    <ul class="nav nav-list">
      <li><a href="#" class="dropdown-toggle"> <i class="icon-picture"></i> <span>Country</span> <b class="arrow icon-angle-down"></b> </a>
        <ul class="submenu">
          ...
          <li class="active"><a href="viewplace.php"> <i class="icon-picture"></i> <span>View Countries</span> <b class="arrow icon-angle-down"></b> </a></li>
        </ul>
      </li>
  ...
  <div id="main-content" class="clearfix">
    <div id="page-content" class="clearfix">
      ...
      <div class="row-fluid">
        ...
        <div class="row-fluid" id="place_list"> </div>
...
<script type="text/javascript">
			...
			$(document).ready(function() {
			    ...
			    $("#place_list" ).load( "ajaxplace.php"); //load initial records
			   
			    //executes code below when user click on pagination links
			    $("#place_list").on( "click", ".paginations a", function (e){
			        e.preventDefault();
			      ...
			      //  product_type=product_type?product_type:'';
			        $("#innerpage_list").load("ajaxplace.php",{"page":page}, function(){ //get content from PHP page
			...
			function myconfirm() {
			   resut= confirm("Are you sure delete place !!! ");
			   if(!resut){
				   return false;
			   }
			}
