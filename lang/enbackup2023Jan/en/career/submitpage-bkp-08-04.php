<?php
	...
	if ($_POST["submit"]) {
		...
		$phone = $_POST['phone'];
		$from = $_POST['fname']; 
		$to = 'HR@dynamic-test.com'; 	   //dreammakerz.sugumar@gmail.com,HR@dynamic-test.com,salesca@dynamic-test.com,petea@dynamic-test.com
        ...
        <div class="span6">
          <form class="enquiry-form" role="form" method="post" action="submitpage.php" onsubmit="return Validate(this);" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="altmob" name="altmob"  disabled value="<?php echo htmlspecialchars($_GET['t']); ?>"><?php echo "<p class='text-danger'>$errAlt</p>";?> 
               </div>
            </div>
            <div class="form-group">
